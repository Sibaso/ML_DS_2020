...
def gather_data():
	...
	with open("C:\\Users\\pl\\Documents\\Python_Project\\ML_DS_2020\\session_1\\TF_IDF\\train_processed.txt",'w') as f:
		f.write('\n'.join(train_data))
	with open("C:\\Users\\pl\\Documents\\Python_Project\\ML_DS_2020\\session_1\\TF_IDF\\test_processed.txt",'w') as f:
		f.write('\n'.join(test_data))

def generate_vocabulary(data_path,min_df=1):
	...
	with open("C:\\Users\\pl\\Documents\\Python_Project\\ML_DS_2020\\session_1\\TF_IDF\\words_idf.txt",'w')as f:
		f.write('\n'.join([word+'<fff>'+str(idf) for word,idf in words_idf]))

def get_tf_idf(data_path,fname):
	...
	with open('C:\\Users\\pl\\Documents\\Python_Project\\ML_DS_2020\\session_1\\TF_IDF\\'+fname+'_tf_idf_vector.txt','w') as f:
		f.write('\n'.join(data_tf_idf))

#gather_data()
#generate_vocabulary("C:\\Users\\pl\\Documents\\Python_Project\\ML_DS_2020\\session_1\\TF_IDF\\train_processed.txt",6)
get_tf_idf("C:\\Users\\pl\\Documents\\Python_Project\\ML_DS_2020\\session_1\\TF_IDF\\train_processed.txt",'train')
get_tf_idf("C:\\Users\\pl\\Documents\\Python_Project\\ML_DS_2020\\session_1\\TF_IDF\\test_processed.txt",'test')